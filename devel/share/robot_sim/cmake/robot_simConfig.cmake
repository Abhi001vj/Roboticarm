...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/marvin/project3_ws/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/marvin/project3_ws/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/marvin/project3_ws/install)
...
if(NOT "/home/marvin/project3_ws/src/robot_sim/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/marvin/project3_ws/src/robot_sim/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marvin/project3_ws/src/robot_sim/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/marvin/project3_ws/devel/lib;/home/marvin/project3_ws/devel/lib;/opt/ros/kinetic/lib)
